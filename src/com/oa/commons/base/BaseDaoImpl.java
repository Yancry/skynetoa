...
/**
 * @author WangYan 数据库操作封装基类 封装了HibernateTemplate 一些繁琐操作 快速开发可只需要这一个dao
 *         service直接调用此dao传sql语句
 * 
 */
@Repository
public class BaseDaoImpl implements IBaseDao {
	...
	/**
	 * 添加 方法已过时 说明，可直接使用save方法，会自动的将生成的数据set到对象里面，不需要单独的使用
	 * 
	 * @param obj
	 *            需要添加的对象
	...
	/**
	 * 批量添加或更新 批量操作 需要设置 hibernate.jdbc.batch_size=20
	 ...
	 *            语句
	 * @param values
	 *            ?占位符对应的参数(List参数 list 索引对应 ？占位符位置)
	 * @return boolean 更新成功或失败
	 */
