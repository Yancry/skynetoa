...
/**
 * 
 * 类名：BaseAction 功能：action 父类 详细：所有action类的父类 一些常用方法 作者：Wangyan 版本：1.0
 * 日期：2017-7-1 下午2:53:27
 *
 */
public abstract class BaseAction {
	...
	protected ModelAndView ajaxJsonEscape(Object message) {
		...
		mav.addObject(MsgConfig.MSGINFO,
				JSON.toJSONString(message).replaceAll("<script", "&lt;script").replaceAll("</script", "&lt;/script"));
		return mav;
	}
