...
/**
 * 
 * 类名：MsgConfig 功能：消息配置文件 详细： 作者：WangYan 版本：1.0 日期：2017-6-29 上午9:46:54
 *
 */
public interface MsgConfig {
	...
	/**
	 * dwz message 占位符赋值 {1}{2} 多个值用，隔开 值：messageValues
	 */
