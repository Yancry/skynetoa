...
public class UserAction extends BaseAction {
	...
	public ModelAndView add(@Valid SyUsers user, Errors errors, String roleIds) throws UnsupportedEncodingException {
		...
		// 解密
		String pwd = RSAUtils.decryptStringByJs((String) ServletUtil.getSession().getAttribute("jmpw"),
	...
	public ModelAndView updateMyPw(String oldPassword, String userPassword, String pwd)
			throws UnsupportedEncodingException {
	...
	public String myLoginInfo(HttpSession session, ModelMap map) {
		...
		Map<String, LoginInfo> infos = ServletUtil.getOnLineUsers().get(ServletUtil.getMember().getId())
				.getLoginInfos();
