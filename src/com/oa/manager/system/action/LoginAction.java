...
/**
 * 
 * 类名：LoginAction 功能：登录模块 详细：用户登录 作者：WangYan 版本：1.0 日期：2017-7-3 下午3:16:19
 *
 */
@Controller
...
public class LoginAction extends BaseAction {
	 ...
	 */
	@RequestMapping("go")
	public ModelAndView login(String vercode, String name, String password, HttpServletRequest request,
