...
/**
 * 
 * 类名：TaskBaseServiceImpl
 * 功能：
 * 详细：
 * 作者：WangYan
 * 版本：1.0
 * 日期：2017-7-12 上午10:19:16
 *
 */
public class TaskBaseServiceImpl extends BaseServiceImpl{
     ...
     * @throws Exception 
     */  
    public synchronized void  backProcess(String taskId, String activityId, Map<String, Object> variables) {  
    	try {
	        // 查找所有并行任务节点，同时驳回  
