...
<form method="post" action="workflow/copy.do" onsubmit="return validateSubmitForm(this)">
						
	<table class="table table-bordered " >
			<tr>
				<th style="width: 80px"><span class="badge badge-warning">注意：</span></th>
				<td>
					
					<span class="alert alert-info">流程复制，只是复制流程设计，其他信息还需要重新填写。</span>
				</td>
			</tr>
			<tr>
				<th>新流程名称：</th>
			...
			<tr>
				<th>流程类型：</th>
				<td>
					<select class="easyui-validatebox" required="true"  name="flowType">
	...
	<input type="hidden" name="fromId" value="${param.id}"/>
