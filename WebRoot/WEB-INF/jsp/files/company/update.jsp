...
<form method="post" action="companyFiles/update.do" enctype="multipart/form-data"   onsubmit="return validateSubmitForm(this)">
						
	<table class="table table-bordered ">
			<tr>
				<th style="width: 80px">文档分类：</th>
				<td>
					<a href="companyFiles/type/lookUpPage.do?type=1" lookupGroup="type" title="分类查询" width="500" height="350">
						<input type="text"  readonly="readonly"  toName="type.name" class="span2" value="<c:out value="${requestScope.type}" />"/>
					</a>
