...
<form method="post" action="shareFiles/updateFile.do" enctype="multipart/form-data"   onsubmit="return validateSubmitForm(this)">
						
	<table class="table table-bordered ">
			<tr>
				<th style="width: 80px">上级目录：</th>
				<td>
					<a href="shareFiles/lookUpPage.do" lookupGroup="type" title="目录查询" width="500" height="350">
