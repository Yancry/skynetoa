...
<div class="easyui-layout" fit="true">
   <!-- 左侧-->
	<div region="west" title="个人通讯录" split="true"	style="width:180px;" >
	...
	<div  region="center" border="false">
		<%@ include file="/WEB-INF/jsp/personalOffice/addressBook/personal/query.jsp"%>
	</div>
		...
		$.ajax({
			...
			success:function(json){
				...
				$.each(json, function(i, d) {
					...
					zNodes.push({id : d.id,name : d.grName,open:true,
					datagrid : rel,param : {"id":d.id},updateTitle:"分组查询--"+d.grName});
