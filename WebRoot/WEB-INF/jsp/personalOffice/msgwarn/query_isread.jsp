...
<!--	
	...
	$(function() {
		...
		$('#<%=request.getParameter("rel")%>_datagrid').datagrid({
			url : "msgwarn/query.do?readState=1",
			columns : [ [ 
			    {
			    	field:"ck",
			    	title : "勾选",
			    ...
			    },
				{
					...
					formatter: function(value,row,index){
						...
						var html='<a href="msgwarn/show.do?id='+row.id+'&rel=<%=request.getParameter("rel")%>_show" target="dialog" width="1000" height="450" title="消息提醒详情" rel="<%=request.getParameter("rel")%>_show">';
