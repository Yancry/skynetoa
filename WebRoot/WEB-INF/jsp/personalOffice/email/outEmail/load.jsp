	...
	<form onsubmit="return datagridSearch(this,'${param.rel }_datagrid');">
		<div class="search-content ">
			...
			<span> <label>
						...
						<span> <label>发送日期：</label>
								<input type="text"  readonly="readonly" onFocus="WdatePicker()"  name="date1" style="width: 100PX" />
								<span class="limit">-</span>
								<input type="text"  readonly="readonly" onFocus="WdatePicker()" name="date2" style="width: 100PX" />
						</span>
						</div>
			...
			<span style="float: left;">
				<a class="easyui-linkbutton clearDgChecked"  icon="icon-redo"	plain="true"  title="清空所有勾选项" >清空勾选</a>
						...
						<a class="easyui-linkbutton" icon="icon-remove" plain="true"
							href="email/delOut.do" target="selectedTodo" rel="ids"
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											...
											return '<a  datagrid="${param.rel }_datagrid" href="email/findOut.do?id='
													+ row.id
