...
<script type="text/javascript" src="resource/js/ckeditor/adapters/jquery.js" charset="utf-8"></script>
...
<%--影响 easyui portal插件   --%>
<%--<script src="resource/js/fullcalendar/jquery-ui.custom.min.js" type="text/javascript"></script>--%>
