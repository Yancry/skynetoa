...
<body class="loginPageBody" >
	...
	<div class="LoginWrapbg ">
			...
			<div class="loginBar">
				<div id="divcenter_login" >
					<div class="fieldWrap" >
						...
						<div class="inputWrap">
							<input type="text"  id="username" class="inputText" value="wangyan">
						</div>
					</div>
					<div class="fieldWrap" >
		...
		<div class="copyright">
			<div class="center">Copyright &copy; 2016-2017 <a href="<fmt:message key="app.name.url" bundle="${commonBundle}"/>" target="_blank" ><fmt:message key="app.name" bundle="${commonBundle}"/></a>&nbsp;提供计算服务</div>
		</div>
	</div>
</body>
</html>
