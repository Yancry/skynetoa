...
<%--					</my:validationAuthority>		--%>
					...
					<button  class="btn btn-primary btn-small"  target="dialog"  width="850" height="620" rel="${param.rel }_select" title="查询框" href="staff/searchTag.do?search=res&rel=${param.rel}" >
						高级检索</button>
					&nbsp;
