...
<%--		<input id="${param.rel}_id" name="puGrouping" type="hidden" value="0" />--%>
		<div class="search-content ">
			<span> <label>
							姓名：</label><input type="text" name="psName" style="width: 90px" value="<c:out value="${param.psName }" />"  op="like" />
			...
			<span style="float: left;"> 
				<a class="easyui-linkbutton clearDgChecked"  icon="icon-redo"	plain="true"  title="清空所有勾选项" >清空勾选</a>
					...
					<shiro:hasPermission name="staff:add">
						<a class="easyui-linkbutton" icon="icon-add" plain="true" title="添加员工"
...
<%--							rel="${param.rel}_gxzt" warn="请选择一条信息"><span>更新状态</span>--%>
<%--						</a>--%>
