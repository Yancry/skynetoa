...
<form method="post" action="projectTask/add.do" enctype="multipart/form-data" onsubmit="return validateSubmitForm(this)">
	...
	<table class="table table-bordered ">
			...
			<tr>
				<th>任务时间：</th>
				<td>
					<input type="text"  name="startTime" id="projectTask_add" class="easyui-validatebox" required="true"  style="width: 140px"  readonly="readonly" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" />
					--
					<input type="text"  name="endTime"  class="easyui-validatebox" required="true"   readonly="readonly"  style="width: 140px"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'projectTask_add\');}'})" />
				</td>
			</tr>
			<tr>
				<th>执行人：</th>
