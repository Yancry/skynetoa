	...
	<form action="info/update.do" method="post"
		...
		<table class="table table-bordered ">
			<tr>
				...
				<td>
					<input type="text" name="clNo" class="easyui-validatebox" required="true"
				...
				<td>
					<input type="text" name="clName" class="easyui-validatebox" required="true"
			...
			<tr>
				...
				<td colspan="3">
					<textarea name="clRemark" rows="6" cols="100" style="width: 608px"><c:out value="${requestScope.info.clRemark }" /></textarea>
				</td>
			</tr>
