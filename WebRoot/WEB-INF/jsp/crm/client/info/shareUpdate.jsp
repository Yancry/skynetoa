...
<div style="width: 800px; margin: 0 auto;">
	<form action="info/shareUpdate.do" method="post"
				...
				<td colspan="3">
					<a href="dept/lookUpPage.do?type=2" lookupGroup="dept"
						title="部门查询"> <textarea readonly="readonly"
							toName="dept.deptName" rows="2" style="width: 600PX" ><my:outDeptName id="${requestScope.deptIds}"/></textarea> </a>
				...
				<td colspan="3">
					...
					<a href="user/lookUpPage.do?type=2" lookupGroup="user" title="用户查询">
						<textarea readonly="readonly" toName="user.trueName" rows="2"
							style="width: 600PX" ><my:outTrueName id="${requestScope.userIds}"/></textarea>
					</a>
