...
<div id="${param.rel}_toolbar" class="search-div">
	<form	onsubmit="return datagridSearch(this,'${param.rel }_datagrid');"  formatFilterData="true" >
		<div class="search-content ">
			<span> <label>
					客户编号：
				</label> <input type="text" name="o.clNo" style="width: 90px" op="like"
					 />&nbsp;<i class="boot_icon-question-sign" selectLike="tooltip"></i> </span>
			
			<span> <label>
					客户名称：
				</label> <input type="text" name="o.clName" style="width: 90px" op="like"
					 />&nbsp;<i class="boot_icon-question-sign" selectLike="tooltip"></i> </span>
			
			<span >
				<label>客户类别：</label>
				<select   name="o.clCategory"  style="width: 100px;" submitForm="change"   >
			...
			<span >
				<label>客户等级：</label>
				<select   name="o.clGrade"  style="width: 100px;" submitForm="change"   >
					<option value="">全部</option>
			...
			<span >
				<label>所属行业：</label>
				<select   name="o.clIndustry"  style="width: 100px;" submitForm="change"   >
					<option value="">全部</option>
...
<%--				<a class="easyui-linkbutton clearDgChecked"  icon="icon-redo"	plain="true"  title="清空所有勾选项" >清空勾选</a>--%>
					...
					title="高级搜索" href="info/searchTagShare.do?rel=${param.rel}" target="dialog"  width="650" height="350"  rel="${param.rel}_queryfilter"  >高级查询</a>
