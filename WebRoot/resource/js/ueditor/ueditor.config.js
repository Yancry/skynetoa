...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,webRootPath:appWebRoot				//****自定义配置 网站根目录
        //图片上传配置区
        ,imageUrl:appWebRoot+"imageSpace/ueditor/add.do"             //图片上传提交地址
        ,imagePath:appWebRoot                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       ...
       // ,savePath: [ 'upload']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        ,savePathUrl:appWebRoot+"imageSpace/type/list.do" //**** 自定义配置 远程获取上传目录列表,不使用savePath
        ...
        //附件上传配置区
        ,fileUrl:URL+"fileUp.jsp"               //附件上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:appWebRoot + "imageSpace/ueditor/imageManager.do"       //图片在线管理的处理地址
        ,imageManagerPath:appWebRoot                                   //图片修正地址，同imagePath
        ...
        //word转存配置区
        ,wordImageUrl:appWebRoot+"imageSpace/ueditor/wordImage/add.do"            //word转存提交地址
        ,wordImagePath:""                          //
        ,wordImageFieldName:"file"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'insertvideo', 'music',  'map', 'gmap', 'insertframe','insertcode', 'pagebreak', 'template', 'background', '|',
